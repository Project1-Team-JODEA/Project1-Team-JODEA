                ...
                <form id="passwdreset" class="input-group"
                    ...
                    <table>
                        ...
                        <c:if test="${searched && searched == 'true'&& ver != 'y-d'}">
                            ...
                            <tr>
                                <td><select title="Select Reset Method" name="rsmethod" id="methodtype">
                                        <option title="none" value="">Select</option>
                            ...
                            <tr><td><input title="click send code" type="submit"
                                           name="sendCode" value="Send Code to email" onclick="pageAction('sendCode')">
                                </td></tr>
                            <tr><td><input title="type 6 digit code" type="number" maxlength="6" 
...
//                es[i]
                        ...
                        document.getElementById("methodtype").onchange=function() {
